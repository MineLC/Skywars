...
import lc.mine.skywars.game.chestrefill.gui.ChestPreviewItemsGui;
import lc.mine.skywars.game.chestrefill.gui.ChestRefillGui;

public class ChestRefillConfigLoader {

    private final Logger logger;

    public ChestRefillConfigLoader(Logger logger) {
        this.logger = logger;
    }

    public void load(final ConfigSection config, final ChestRefillConfig chestConfig) {
        ...
        chestConfig.setInventory(inventory);
        chestConfig.setModes(modesArray);
    }
